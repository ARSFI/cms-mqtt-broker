...
#define MyAppName "CMS MQTT Broker"
#define MyAppPublisher "Amateur Radio Safety Foundation, Inc"
#define MyAppURL "http://www.winlink.org/"
#define MyAppExeName "MQTTnet.Server.exe"
#define SourceDir "D:\Projects\cms-mqtt-broker\MQTTnet.Server\bin\Release\net5.0\publish\"

#define VerExe 'D:\Projects\cms-mqtt-broker\MQTTnet.Server\bin\Release\net5.0\publish\MQTTnet.Server.exe'
...
DefaultDirName={commonpf}\Winlink 2000\CMS MQTT Broker
DisableDirPage=yes
...
Filename: {sys}\sc.exe; Parameters: "create CMSMqttBroker DisplayName= ""CMS MQTT Broker"" start= demand binPath= ""{app}\MQTTnet.Server.exe""" ; Flags: runhidden

[UninstallRun]
Filename: {sys}\sc.exe; Parameters: "stop CMSMqttBroker" ; Flags: runhidden
Filename: {sys}\sc.exe; Parameters: "delete CMSMqttBroker" ; Flags: runhidden
