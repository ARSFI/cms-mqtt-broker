...
Filename: {sys}\sc.exe; Parameters: "create MirroringMqttBroker DisplayName= ""Mirroring MQTT Broker"" start= demand binPath= ""{app}\MQTTnet.Server.exe""" ; Flags: runhidden; AfterInstall: SelectSettingsFileForServer('{app}')
